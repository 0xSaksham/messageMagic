...
const page = () => {
  ...
  // Request to check for unique username after 500 milliseconds
    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-800">
      <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md">
        <div className="text-center">
          ...
          <p className="mb-4">
            Mystery Message allows you to send and recieve anonymous messages!
          </p>
        </div>
        <Form {...form}>
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  {!isCheckingUsername && usernameMessage && (
                    <p
                      className={`text-sm ${
                        usernameMessage ? "text-green-500" : "text-red-500"
                      }`}
                    >
                      {usernameMessage}
                    </p>
